<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobDetails2.aspx.cs" Inherits="Details" %>
...
<section id="content">
	<div class="container">
    <form id="Form1" method="post" runat="server" EncType="multipart/form-data" action="applicationForm2.aspx">
    <div>
        ...
        <button onclick="javascript:history.go(-1); return false;">
         ...
         <button onclick="applicationForm()">Apply</button>  
                            ...
                            <li>
                             ...
                             <li>
                              ...
                              <li>
                                ...
                                <span class="btn btn-default btn-file btn-primary">Browse... <INPUT id="oFile" type="file" runat="server" NAME="oFile"></span>
...
<%--           <div id="applicationForm" class="sixteen columns contentbox lb">
               <div class="contentpadding">
                   <h2>Application Form</h2>
                    <form name="applicationForm" method="post" action="applicationForm2.aspx">
                        <ul>                            
                             <li>
                                <label for="appName" id="appName">Name</label>
                                <input type="text" name="appName" placeholder="Name" />
