...
<script runat="server" type="text/vbscript">
        ...
        Sub Page_Load(sender As Object, e As EventArgs)
            ...
            Dim SendResultsTo As String = "admin@triad.co.uk"
            Dim smtpMailServer As String = "217.36.34.178"
            Dim smtpUsername As String = ""
            Dim smtpPassword As String = ""
            Dim MailSubject As String = "Triad enquiry"
			
			Dim Sender_name = Page.Request.Form("name")
			Dim Sender_position = Page.Request.Form("position")
			Dim Sender_organisation = Page.Request.Form("organisation")
			Dim Sender_phone =  Page.Request.Form("number")
			Dim Sender_email = Page.Request.Form("email")
			Dim Sender_message = Page.Request.Form("message")
            ...
            Try
				 ...
				 msgBody.Append("organisation: " & Sender_organisation & vbCrLf )
                ...
                myMessage.To.Add(SendResultsCC)
